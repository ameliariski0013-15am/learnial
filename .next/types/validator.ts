...
// Validate ../../app/api/flashcard/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/flashcard">> = Specific
  const handler = {} as typeof import("../../app/api/flashcard/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
